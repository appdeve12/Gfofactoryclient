...
import { addstockinward, getparticulrstockinward } from '../../services/allService';
...
const response=await addstockinward(formData);
          ...
          <Form onSubmit={handleSubmit}>
            <Row className="mb-3">
              <Col md={4}>
                ...
                <CustomDropdown RoleDropdownData={material_Name_dropdown} onChange={handleSelect}   value={formData.material_Name}/>
              </Col>
